...
@section('main')
    ...
    <div class="card-box">
        <div class="header-title">Silahkan Tambahkan Diklat/Kompetensi yang Anda Dibutuhkan</div>
        {{-- <div class="text-danger">Beri tanda centang <i class="fe-check-square text-primary"></i> pada Diklat yang telah diikuti</div> --}}
    </div>

    <div class="card-box">
        <button type="button" class="btn btn-info mb-2" data-toggle="modal" data-target="#modal-diklat">
            Tambah
          </button>
            <table id="" class="table table-striped dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <table id="datatable" class="table table-striped  dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        @foreach($diklat as $d)   
                            <tr>
                                <td>
                                    <button onclick="add('{{ $d->id }}')" class="btn btn-sm py-1 px-2 btn-info"><i class="icon-plus"></i></button>
                                </td>
                                <td>{{ $d->nama }}</td>
